...
namespace Core.BulkLoad
{
    public class BulkLoad60s
    {
        ...
        //            value.Low + "^" + value.Close + "^" + value.Volume + "^" + value.SMA60High + "^" + value.SMA60Low + "^" + value.SMA60Close + value.Slope60High + "^" + value.Slope60Low + "^" + value.Slope60Close;
