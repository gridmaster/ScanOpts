...
namespace Core.BusinessModels
{
    public class SlopeAndBBCounts
    {
        ...
        public int CountStandardDeviation { get; set; }
        public int CountUpperBand { get; set; }
        public int CountLowerBand { get; set; }
        public int CountBandRatio { get; set; }
    }
}
