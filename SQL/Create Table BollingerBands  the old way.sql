...
/****** Object:  Table [dbo].[BollingerBands01122018Daily]    Script Date: 01/27/2018 17:45:55 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[BollingerBands01122018Daily] ADD  CONSTRAINT [CreateTS_DF]  DEFAULT (getdate()) FOR [Timestamp]
GO
